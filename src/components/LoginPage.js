        ...
        <Container component="main" maxWidth="xs" className={classes.loginPage}>
          <Paper elevation="3" style={{ padding: "8%" }}>
            ...
            <form className={classes.form} onSubmit={this.handleLoginSubmit}>
              ...
              <Grid container>
                ...
                <Grid
                  item
                  sm={7}
                  style={{ paddingTop: "1%", textAlign: "right" }}
                ></Grid>
              </Grid>
            </form>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  Enter your registered email id. An Email with a verification
                  code will be sent to this email id.
                </DialogContentText>
                <TextField
                  autoFocus
                  margin="dense"
                  ...
                  fullWidth
                  onChange={(e) =>
                    this.setState({ dialogEmail: e.target.value })
                  }
                />
              </DialogContent>
              <DialogActions>
