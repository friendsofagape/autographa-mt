  ...
  render() {
    ...
    return (
      <Grid container>
        ...
        { this.state.bkvalue &&
          <Grid item container style={{paddingTop:'2%',paddingLeft:'10px'}} spacing={0}>
            <Grid item sm={3} style={{paddingRight:'2%'}}>
                ...
                <Grid container style={{paddingBottom:'2%'}}>
                    ...
                    <Grid item sm={2}>
                      <Tooltip title="Click here to reload tokens">
                        <CachedIcon fontSize='small' color='secondary' onClick={()=>{this.updateState(this.state.bkvalue)}} />
                      </Tooltip>
                    </Grid>
                    <Grid item sm={1}></Grid>
                </Grid>
                ...
                <Grid item sm={12} style={{paddingLeft:'0%',paddingRight:'0%',paddingTop:'3%',paddingBottom:'2%'}}>
                    ...
                    <Paper elevation='1'>
                      <TokenList checkvalue={this.state.checkBox} untoken={this.state.untoken} allList={this.state.allList} bk={this.state.bkvalue}  tokenUpdateState={this.tokenUpdateState} />
                    </Paper>
                </Grid>
              </Grid>
              ...
              <Grid item sm={12} style={{paddingLeft:'0%',paddingRight:'0%',paddingTop:'2%',paddingBottom:'2%'}}>
                <Paper elevation='1'>
                  <Concordance  updateState={this.updateState}
                      bkvalue={this.state.bkvalue} 
                      tokenUpdateData={this.state.tokenUpdateData} 
                      tokenSelected={this.state.tokenSelected} />
                  <TranslationsWords updateState={this.updateState}
                      bkvalue={this.state.bkvalue} 
                      tokenUpdateData={this.state.tokenUpdateData} 
                      tokenSelected={this.state.tokenSelected} />
                </Paper>
