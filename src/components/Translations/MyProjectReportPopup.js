...
export default function SimplePopover(props) {
      ...
      fetch(
        ...
        .then((data) => {
          if (
            ...
            setUnTokenisedOldBooks(oldTestments.length - oldBooks.length);
  ...
  const columns = [
    {
      name: (
        <span style={{ fontSize: "90%", fontWeight: "bold" }}>BOOK NAME</span>
      ),
      selector: "bookCode",
      sortable: true,
      cell: (row) => (
  ...
  return (
    <div style={{ textAlign: "center" }}>
      <Tooltip title="Bookwise Translation Progress">
        <Button
