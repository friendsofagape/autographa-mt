				...
				...columns,
				{
					...
					options: {
						...
						customBodyRender: (value) => {
							return (
								<Button
									onClick={() => this.setState({ listBooks: true }, this.handleBookSelect(value))}
								>
									View
								</Button>
							);
						...
						customBodyRender: (value) => {
							return (
								<Button
									size="small"
									variant="contained"
									onClick={() => this.setState({ dialogOpen: true, sourceId: value })}
								>
									Upload
								</Button>
							);
		...
		return (
			<div className={classes.root}>
				...
				<MuiThemeProvider theme={getMuiTheme()}>
					<MUIDataTable title={'Sources List'} data={data} columns={columns} options={options} />
				</MuiThemeProvider>
